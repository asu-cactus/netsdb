...
#  ---K candidate distances: the level of indirectness from the candidate lambda to current computation
#  ---K candidate frequency
#  ---K candidate relative selectivity: the historical average of the candidate lambda's output size to current input size
#  ---Current input size
#  ---Number of nodes in the cluster
#Output: probability distribution of all actions
    ...
    def predict(self, inputs):
        print("predict inputs in actor network:")
        print(inputs)
...
class CriticNetwork(object):
    ...
    #input: the state and action 
    #output: value function V(s), which represents the cumulative reward in a long run
    ...
    def predict(self, inputs):
        print ("inputs in critic network:")
        print (inputs)
        return self.sess.run(self.out, feed_dict={
            self.inputs: inputs
        })
