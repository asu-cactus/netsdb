...
public:
    ...
    Q01ValueClass (LineItem & lineitem) {
...
class Q01Agg : public ClusterAggregateComp<Q01AggOut,
                                               LineItem,
                                               Q01KeyClass,
                                               Q01ValueClass> {
...
public:
    ...
    Lambda<Q01KeyClass> getKeyProjection(Handle<LineItem> aggMe) override {
    ...
    Lambda<Q01ValueClass> getValueProjection (Handle<LineItem> aggMe) override {
         return makeLambda(aggMe, [](Handle<LineItem>& aggMe) {
