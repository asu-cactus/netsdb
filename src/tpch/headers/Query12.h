...
class Q12LineItemSelection : public SelectionComp<LineItem, LineItem> {
...
public:
    ...
    Q12JoinOut (Order order, LineItem lineItem) {
...
class Q12Join : public JoinComp<Q12JoinOut, Order, LineItem> {
...
public:
    ...
    Lambda<Handle<Q12JoinOut>> getProjection(Handle<Order> in1, Handle<LineItem> in2) override {
        return makeLambda(in1, in2, [](Handle<Order>& in1, Handle<LineItem>& in2) { 
...
class Q12Agg : public ClusterAggregateComp<Q12AggOut,
                                               Q12JoinOut,
                                               String,
                                               Q12ValueClass> {
