...
public:
   ...
   Customer (int c_custkey, std::string c_name, std::string c_address, int c_nationkey,
...
public:
   ...
   LineItem (int l_orderkey, int l_partkey, int l_suppkey, int l_linenumber,
...
public:
   ...
   Nation(int n_nationkey, std::string n_name, int n_regionkey, std::string n_comment) {
...
public:
   ...
   Order(int o_orderkey, int o_custkey, std::string o_orderstatus, double o_totalprice, 
...
public:
   ...
   Part (int p_partkey, std::string p_name, std::string p_mfgr, std::string p_brand,
...
public:
   ...
   PartSupp (int ps_partkey, int ps_suppkey, int ps_availqty, double ps_supplycost,
...
public:
   ...
   Region (int r_regionkey, std::string r_name, std::string r_comment) {
...
public:
   ...
   Supplier (int s_suppkey, std::string s_name, std::string s_address, int s_nationkey,
