...
public:
    ...
    Q14JoinOut(LineItem & lineitem, Part & part) {
...
class Q14Join : public JoinComp<Q14JoinOut, LineItem, Part> {
...
public:
    ...
    Lambda<bool> getSelection (Handle<LineItem> in1, Handle<Part> in2) override {
        return makeLambdaFromMember(in1, l_partkey) == makeLambdaFromMember(in2,
           p_partkey);

    }

    Lambda<Handle<Q14JoinOut>> getProjection(Handle<LineItem> in1, Handle<Part> in2) override {
        return makeLambda(in1, in2, [](Handle<LineItem>& in1, Handle<Part>& in2) {
...
class Q14LineItemSelection : public SelectionComp<LineItem, LineItem> {
...
class Q14Agg : public ClusterAggregateComp<Q14AggOut,
                                               Q14JoinOut,
                                               int,
                                               Q14ValueClass> {
