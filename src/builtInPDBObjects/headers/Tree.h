...
class Tree : public Object {
  ...
  public:
        ...
        for (int i = 0; i < relationships.size(); ++i) {
            ...
            if (modelType == ModelType::RandomForest) {
                ...
                if (!leftChildString.empty()) {
                    ...
                    if (bool isLeftChildLeaf = (leftChildString[2] == 'L')) {
                ...
                if (!rightChildString.empty()) {
                    ...
                    if (bool isRighChildLeaf = (rightChildString[2] == 'L')) {
    ...
    void constructTreeFromPath(std::string &treePathIn, ModelType modelType) {
        ...
        constructTreeFromPath(treePathIn, modelType, relationships, innerNodes, leafNodes);
    ...
    static void constructTreeFromPath(
