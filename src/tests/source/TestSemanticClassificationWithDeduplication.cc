...
int main(int argc, char* argv[]) {
    ...
    //create a shared set
	 ...
	 //create the set for storing shared weights 
         ...
         ff::loadMatrix(pdbClient, "text-classification", "shared_weights", numBlock_x*block_x, sharedNumBlock_y*block_y, block_x, block_y, false, false, errMsg);
	 ...
	 //0 private pages, 16 shared pages
         ...
         ff::loadMatrix(pdbClient, "text-classification", "inputs", batchSize, matrix_totalNumBlock_y*block_y, block_x,
