...
#ifndef TEST_WIKI250_CIVIL_CC
#define TEST_WIKI250_CIVIL_CC
...
int main(int argc, char *argv[]) {
    ...
    pdb::PDBLoggerPtr clientLogger =
        make_shared<pdb::PDBLogger>("WIKI250_CIVIL_Log");
    ...
    // run the computation
    if (!pdbClient.executeComputations(errMsg, "WIKI250_CIVIL", materializeHash,
                                       myWriter)) {
