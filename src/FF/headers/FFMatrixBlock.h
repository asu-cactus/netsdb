...
public:
    ...
    FFMatrixBlock(int blockRowIndexIn, int blockColIndexIn, int rowNumsIn, int colNumsIn) {
        ...
        // std::cout << "This is risky, please call the other constructor. FFMatrixBlock constructor
        // RawData size:" << (data.rawData)->size() << std::endl;
    }

    FFMatrixBlock(int blockRowIndexIn,
                int blockColIndexIn,
                int rowNumsIn,
                int colNumsIn,
                int totalRows,
        ...
        data.rawData =
            pdb::makeObject<pdb::Vector<double>>(rowNumsIn * colNumsIn, rowNumsIn * colNumsIn);
        // std::cout << "FFMatrixBlock constructor RawData size:" << (data.rawData)->size() <<
        // std::endl;
    }
