...
do
    ...
    do
        ...
        do
            ...
            ./bin/LoadAmazon14kData localhost 8108 Y N $models 500 500 Y 1000 14588 597540 1000 N > share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k Y $models N >> share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k Y $models N >> share_${models}_1_server_${mem}_${threads}.log 2>&1
            ...
            ./bin/LoadAmazon14kData localhost 8108 N Y $models 500 500 Y 1000 14588 597540 1000 Y >> share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k N $models Y >> share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k N $models Y >> share_${models}_1_server_${mem}_${threads}.log 2>&1
            ...
            ./bin/LoadAmazon14kData localhost 8108 Y N $models 500 500 N 1000 14588 597540 1000 N > no_share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k Y $models N >> no_share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k Y $models N >> no_share_${models}_1_server_${mem}_${threads}.log 2>&1
            ...
            ./bin/LoadAmazon14kData localhost 8108 N Y $models 500 500 N 1000 14588 597540 1000 Y >> no_share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k N $models Y >> no_share_${models}_1_server_${mem}_${threads}.log 2>&1
            ./bin/RunAmazon14k N $models Y >> no_share_${models}_1_server_${mem}_${threads}.log 2>&1
