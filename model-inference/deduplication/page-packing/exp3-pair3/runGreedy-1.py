...
input_1 = np.load('../data/exp3-pair3_50*10000_64/m1.npy', allow_pickle=True).item()
...
input_2 = np.load('../data/exp3-pair3_50*10000_64/m2.npy', allow_pickle=True).item()
...
np.save('../data/tensor_list_exp3-pair3.npy', output)

# load the input file
input = np.load('../data/tensor_list_exp3-pair3.npy', allow_pickle=True).item()
tensor_list_model = [{}, {}]
list_of_tensors = [[], []]
