...
input_1 = np.load('../data/exp1_50*10000_64/m1.npy', allow_pickle=True).item()
...
input_2 = np.load('../data/exp1_50*10000_64/m2.npy', allow_pickle=True).item()
...
input_3 = np.load('../data/exp1_50*10000_64/m3.npy', allow_pickle=True).item()
...
input_4 = np.load('../data/exp1_50*10000_64/m4.npy', allow_pickle=True).item()
...
np.save('../data/tensor_list_exp1.npy', output)

# load the input file
input = np.load('../data/tensor_list_exp1.npy', allow_pickle=True).item()
tensor_list_model = [{}, {}, {}, {}]
...
with open('output_exp2.csv', 'w') as f:
    write = csv.writer(f)
    write.writerows(L[0].p_i_j)
"""