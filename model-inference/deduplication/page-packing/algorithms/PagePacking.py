...
These testing examples can be found in runGreedy-2.py in the corresponding 9 folders
"""
def exp_greedy1(tensor_list, blocks_in_page):
    ...
    tensor_id_array = np.arange(num_tensors)

    for i in range(num_tensors+1,0,-1):
        temp = combinations(tensor_id_array.tolist(),i)
        temp_list = list(temp)
    ...
    for i in range(len(tuple_list)):
        ...
        output_model_block_map[''.join(str(this_tuple))] = this_list
...
3:OUTPUT: {𝑃𝑖𝑗} (an approximate optimal bin-packing scheme) including number of pages needed
Used in the Two-Stage algorithm in the floowing test cases:
1. exp1 (50 * 10000, 64MB)
2. exp2 (50 * 10000, 64MB)
These testing examples can be found in runTwo-Stage.py in the corresponding 2 folders
"""
def exp_four_twostage(tensor_list, blocks_in_page):
    ...
    # start the first stage
    l0123=tensor_list[0].intersection(tensor_list[1], tensor_list[2], tensor_list[3])
    newBins0123 = int(len(l0123) / blocks_in_page)
    numBins = numBins + newBins0123
    ll0123 = list(l0123)
    for i in range(len(l0123)):
    ...
    l012=tensor_list[0].intersection(tensor_list[1], tensor_list[2])-l0123
    newBins012 = int(len(l012) / blocks_in_page)
    numBins = numBins + newBins012
    ll012 = list(l012)
    for i in range(len(l012)):
    ...
    l013=tensor_list[0].intersection(tensor_list[1], tensor_list[3])-l0123
    newBins013 = int(len(l013) / blocks_in_page)
    numBins = numBins + newBins013
    ll013 = list(l013)
    for i in range(len(l013)):
    ...
    l023=tensor_list[0].intersection(tensor_list[2], tensor_list[3])-l0123
    newBins023 = int(len(l023) / blocks_in_page)
    numBins = numBins + newBins023
    ll023 = list(l023)
    for i in range(len(l023)):
    ...
    l123=tensor_list[1].intersection(tensor_list[2], tensor_list[3])-l0123
    newBins123 = int(len(l123) / blocks_in_page)
    numBins = numBins + newBins123
    ll123 = list(l123)
    for i in range(len(l123)):
    ...
    l01=tensor_list[0].intersection(tensor_list[1])-l012-l013-l0123
    newBins01 = int(len(l01) / blocks_in_page)
    numBins = numBins + newBins01
    ll01 = list(l01)
    for i in range(len(l01)):
    ...
    l02=tensor_list[0].intersection(tensor_list[2])-l012-l023-l0123
    newBins02 = int(len(l02) / blocks_in_page)
    numBins = numBins + newBins02
    ll02 = list(l02)
    for i in range(len(l02)):
    ...
    l03=tensor_list[0].intersection(tensor_list[3])-l013-l023-l0123
    newBins03 = int(len(l03) / blocks_in_page)
    numBins = numBins + newBins03
    ll03 = list(l03)
    for i in range(len(l03)):
    ...
    l12=tensor_list[1].intersection(tensor_list[2])-l012-l123-l0123
    newBins12 = int(len(l12) / blocks_in_page)
    numBins = numBins + newBins12
    ll12 = list(l12)
    for i in range(len(l12)):
    ...
    l13=tensor_list[1].intersection(tensor_list[3])-l013-l123-l0123
    newBins13 = int(len(l13) / blocks_in_page)
    numBins = numBins + newBins13
    ll13 = list(l13)
    for i in range(len(l13)):
    ...
    l23=tensor_list[2].intersection(tensor_list[3])-l023-l123-l0123
    newBins23 = int(len(l23) / blocks_in_page)
    numBins = numBins + newBins23
    ll23 = list(l23)
    for i in range(len(l23)):
    ...
    l0=tensor_list[0]-l01-l02-l03-l012-l013-l023-l0123
    newBins0 = int(len(l0) / blocks_in_page)
    numBins = numBins + newBins0
    ll0 = list(l0)
    for i in range(len(l0)):
    ...
    l1=tensor_list[1]-l01-l12-l13-l012-l013-l123-l0123
    newBins1 = int(len(l1) / blocks_in_page)
    numBins = numBins + newBins1
    ll1 = list(l1)
    for i in range(len(l1)):
    ...
    l2=tensor_list[2]-l02-l12-l23-l012-l023-l123-l0123
    newBins2 = int(len(l2) / blocks_in_page)
    numBins = numBins + newBins2
    ll2 = list(l2)
    for i in range(len(l2)):
    ...
    l3=tensor_list[3]-l03-l13-l23-l013-l023-l123-l0123
    newBins3 = int(len(l3) / blocks_in_page)
    numBins = numBins + newBins3
    ll3 = list(l3)
    for i in range(len(l3)):
...
2:INPUT2: blocks_in_page (the maximum number of blocks for each page)
3:OUTPUT: {𝑃𝑖𝑗} (an approximate optimal bin-packing scheme) including number of pages needed
Used in the Two-Stage algorithm in the following 3 test cases:
1. exp3-pair1 (50 * 10000, 64MB)
2. exp3-pair2 (50 * 10000, 64MB)
3. exp3-pair3 (50 * 10000, 64MB)
These testing examples can be found in runTwo-Stage.py in the corresponding 3 folders
"""
def exp_two_twostage(tensor_list, blocks_in_page):
    ...
    # start the first stage
    l01=tensor_list[0].intersection(tensor_list[1])
    newBins01 = int(len(l01) / blocks_in_page)
    numBins = numBins + newBins01
    ll01 = list(l01)
    for i in range(len(l01)):
